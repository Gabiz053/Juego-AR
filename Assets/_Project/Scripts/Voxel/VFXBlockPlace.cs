...
namespace _Project.Scripts.Voxel
{
    ...
    public class VFXBlockPlace : MonoBehaviour
    {
        ...
        private void Configure()
        {
            ...
            // ── Colour over lifetime — quick clean fade ────────
        ...
        private IEnumerator Play()
        {
            ...
            // Subtle scale pop — barely noticeable but feels responsive
        ...
        private IEnumerator ScaleTo(Vector3 target, float dur, System.Func<float,float> ease)
        {
